...
if [ ! -d .git ]; then
  ...
  # Configure to work in main repo's ralph-work subdirectory
  # This will push to the ralph-work folder in the main repository
  git remote add origin https://github.com/landonking-gif/ai_final.git 2>/dev/null || true
  ...
  echo "Each subdirectory in 'generated/' represents a completed user story." >> README.md
  echo "" >> README.md
  echo "## Structure" >> README.md
  echo "\`\`\`" >> README.md
  echo "ralph-work/" >> README.md
  echo "  ├── generated/" >> README.md
  echo "  │   ├── US-001/  # User Story 1" >> README.md
  echo "  │   ├── US-002/  # User Story 2" >> README.md
  echo "  │   └── ..." >> README.md
  ...
  # Try to create orphan branch for ralph-work if main doesn't exist
  git branch -M ralph-work 2>/dev/null || git checkout -b ralph-work 2>/dev/null || true
fi
